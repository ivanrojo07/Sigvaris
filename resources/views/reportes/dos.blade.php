                            ...
                            @foreach($ventasPorFechaPorPaciente as $paciente_id => $ventasPorFecha)
                                @foreach ($ventasPorFecha as $fecha_venta => $ventas)
                                    <tr>
                                        ...
                                        <td>{{$paciente_id ? App\Paciente::find($paciente_id)->nombre : ''}}</td>
                                        <td>{{$paciente_id ? App\Paciente::find($paciente_id)->paterno : ''}}</td>
                                        <td>{{$paciente_id ? App\Paciente::find($paciente_id)->materno : ''}}</td>
                                        <td>{{
