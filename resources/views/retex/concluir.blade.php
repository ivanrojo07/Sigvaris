                ...
                <form role="form" id="form-cliente" method="POST" action="{{route('ventaRetex.create')}}" name="form">
                    ...
                    <input type="hidden" name="precioOri" id="precioOri" value="{{$precioOri}}">
                      <input type="hidden" name="precioNew" id="precioNew" value="{{$precioNew}}">
                       <input type="hidden" name="retex_folio" id="retex_folio" value="{{$retex_folio}}">
                        <input type="hidden" name="garex_folio" id="garex_folio" value="{{$garex_folio}}">
                         <input type="hidden" name="garex_fin" id="garex_fin" value="{{$garex_fin}}">
                          <input type="hidden" name="total_a_pagar" id="total_a_pagar" value="{{$total_a_pagar}}">
                          <input type="hidden" name="skuProductoEntregado" id="skuProductoEntregado" value="{{$skuProductoEntregado}}">
