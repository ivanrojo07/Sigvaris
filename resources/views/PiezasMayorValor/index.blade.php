...
<script type="text/javascript">
	...
	function confirmacion(doctor_id){
		swal("¿Esta seguro de eliminar este Producto de mayor valor?", {
  buttons: {
  	Si: true,
    cancel: "No",    
  },
...
.then((value) => {
  switch (value) {
    ...
    case "Si":
      swal({  
  text: "El Producto de mayor valor se eliminara permanentemente",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
...
<div class="container">
	<div class="card">
		<div class="card-header">
			<div class="row">
				<div class="col-6">
					<h1>Piezas de mayor valor</h1>
				</div>
				<div class="col-6">
					<a class="btn btn-success" href="{{ route('piezasMa.create') }}">
			...
			<table id="precargas" class="table table-striped table-bordered table-hover"
				...
				<tr>
					...
					<div class="row">
							...
							<div class="col-4">
								<form id="form-tienda" role="form" method="POST" action="{{ route('piezasMa.destroy',['piezasMa'=>$re]) }}">
									{{ csrf_field() }}
