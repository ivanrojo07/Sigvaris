					...
					<div class="row">
						...
						<div class="col-6">
							...
							<select name="ordenar_por" class="form-control">
								...
								<option  {{request()->input('ordenar_por') == 'paterno' ? 'selected' : ''}} value="paterno">Apellido materno</option>
								<option {{request()->input('ordenar_por') == 'materno' ? 'selected' : ''}} value="materno">Apellido paterno</option>
							</select>
						</div>
					</div>
