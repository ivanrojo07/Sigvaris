...
Route::get('corte-caja/export/Polanco/ventas', 'CorteCaja\CorteCajaController@exportV')->name('corte-caja.export.polanco.ventas');
Route::get('corte-caja/export/Polanco/cliente', 'CorteCaja\CorteCajaController@exportC')->name('corte-caja.export.polanco.cliente');
