...
Route::resource('piezasMa','PiezasMaController');
Route::resource('piezasMe','PiezasMeController');
...
Route::post('reportes/export/fitter','Reporte\ReporteController@exportFitter')->name('reportes.11.export');
